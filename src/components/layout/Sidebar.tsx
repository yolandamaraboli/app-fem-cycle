...
export function Sidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-[280px] bg-card border-r border-border flex flex-col z-40">
      {/* App branding */}
      <div className="px-6 py-6 border-b border-border">
        <h1 className="text-h3 font-semibold text-primary">Cycle Tracker</h1>
      </div>
          ...
          {navItems.map((item) => (
            <li key={item.path}>
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 px-4 py-3 rounded-button text-body transition-fast ${
                    isActive
